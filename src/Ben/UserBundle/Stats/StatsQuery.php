...
Class StatsQuery{
    ...
    /* Effectif des patients ayant une couverture sociale par type de couverture */
    ...
    {
        return "select count(*) as data from person p inner join consultation c on c.person_id = p.id where motiftype = 'CONSULTATION MEDICALE A LA DEMANDE' {$this->rangeDate}";
    }
    ...
    {
        return "select count(*) as data from person p inner join consultation c on c.person_id = p.id where motiftype = 'EXAMEN MEDICAL SYSTEMATIQUE'{$this->rangeDate}";
    }
    ...
    {
        return "select gender as label, count(*) as data from person p inner join consultation c on c.person_id = p.id where motiftype = 'EXAMEN MEDICAL SYSTEMATIQUE' {$this->rangeDate} group by gender";
    }
