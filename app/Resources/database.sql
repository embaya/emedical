...
INSERT INTO `person` (`id`, `cin`, `nss`, `firstname`, `familyname`, `email`, `birthday`, `birthcity`, `gender`, `contry`, `city`, `address`, `etablissement`, `university`, `gsm`, `cnss`, `cnsstype`, `parent_name`, `parent_address`, `parent_gsm`, `parent_fixe`, `resident`, `handicap`, `needs`, `ishandicap`, `created`) VALUES
